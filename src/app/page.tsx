              ...
              <Card key={education.school}>
                <CardHeader>
                  <div className="flex items-center justify-between gap-x-2 text-base">
                    ...
                    <div className="text-sm tabular-nums text-gray-500 font-mono">
                      {education.start} - {education.end}
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="font-mono mt-1">{education.degree}</CardContent>
              </Card>
            );
          })}
        </Section>
            ...
            return (
              <Card key={work.company}>
                <CardHeader>
                  ...
                  <h4 className="font-sans text-sm font-medium leading-none">
                    {work.title}
                  </h4>
                </CardHeader>
